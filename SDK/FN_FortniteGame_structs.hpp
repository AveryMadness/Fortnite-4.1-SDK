...
struct FFortPlayerPerformanceEstimateSettings
{
	...
	float                                              EncounterPlayerPerformanceWeight;            
             // 0x0030(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FFortTierProgressionInfo
{
	...
	int                                                HighestDef
eatedTier;                                      // 0x0010(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FFortRangedWeaponStats : public FFortBaseWeaponStats
{
	...
	float                                              MaxPreferredRange;                                        // 0x0200(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, 
CPF_ZeroConstructor, CPF_IsPlainOldData)
